package com.nicolascristaldo.horoscopeapp.ui.home
...
import com.nicolascristaldo.horoscopeapp.ui.detail.DetailActivity
...
class MainActivityTest {
    ...
    fun when_horoscope_is_selected_then_open_detail() {
        ...
        onView(withId(R.id.ivHoroscope)).perform(
